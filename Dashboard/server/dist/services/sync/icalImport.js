...
exports.importGoogleIcalFile = importGoogleIcalFile;
...
function parseIcsDateTime(value, dateOnly) {
...
function parseEventsFromIcs(icsText) {
    ...
    for (const line of lines) {
        ...
        if (key.startsWith('SUMMARY'))
            ...
            current.isCompleted = value.trim().toUpperCase() === 'CANCELLED';
...
function extractIcsTexts(filename, fileBuffer) {
...
async function importGoogleIcalFile(params) {
